...
const COPYRIGHT = `/** @preserve Powered by codingstep */`

const PROJECT_ROOT = path.resolve(__dirname, '../../')
const PROJECT_NAME = path.parse(PROJECT_ROOT).name
const HMR_PATH = '/__webpack_hmr'

export { __DEV__, ENABLE_ANALYZE, ENABLE_OPEN, HOST, DEFAULT_PORT, COPYRIGHT, PROJECT_NAME, PROJECT_ROOT, HMR_PATH }
